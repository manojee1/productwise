      ...
      <div className="flex items-start space-x-3 mb-6 animate-fade-in">
        ...
        <div className="flex-1">
          ...
          <div className="bg-glass-bg backdrop-blur-glass border border-glass-border rounded-2xl p-4 shadow-glass hover:shadow-glass-hover transition-all duration-300">
            <div 
              className="text-sm text-glass-text prose prose-sm max-w-none prose-headings:text-white prose-headings:font-extrabold prose-p:mb-3 prose-ul:my-2 prose-ol:my-2 prose-li:my-1 prose-li:text-white prose-ul:list-disc prose-ol:list-decimal prose-strong:text-primary prose-code:text-primary prose-code:bg-primary/10 prose-code:px-1 prose-code:rounded"
